...
pub fn build(b: *std.Build) !void {
    ...
    if (target.result.os.tag == .windows) {
        ...
        // Add standard MSVC and Windows SDK library paths

        // Adjust these paths based on your Visual Studio and Windows SDK installation
        ...
        const sdk_version = "10.0.26100.0";  // From your CMake output
        ...
        // Link runtime libraries based on optimize mode
